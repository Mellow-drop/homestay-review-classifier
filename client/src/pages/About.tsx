      ...
      <main className="flex-grow mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 w-full">
        <div className="space-y-12 max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-350 max-w-2xl mx-auto font-normal">
          ...
          <div className="rounded-3xl glass-card p-8 md:p-12 border shadow-sm space-y-6">
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              hospitality, and cleanliness. **SentiNest** was built to empower our administration team with advanced sentiment analysis, 
